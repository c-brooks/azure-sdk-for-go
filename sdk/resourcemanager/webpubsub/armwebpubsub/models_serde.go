...
func (e *EventHandler) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "auth":
			err = unpopulate(val, "Auth", &e.Auth)
			delete(rawMsg, key)
		case "systemEvents":
			err = unpopulate(val, "SystemEvents", &e.SystemEvents)
			delete(rawMsg, key)
		case "urlTemplate":
			err = unpopulate(val, "URLTemplate", &e.URLTemplate)
			delete(rawMsg, key)
		case "userEventPattern":
			err = unpopulate(val, "UserEventPattern", &e.UserEventPattern)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", e, err)
...
func (e EventHubEndpoint) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "fullyQualifiedNamespace", e.FullyQualifiedNamespace)
	objectMap["type"] = EventListenerEndpointDiscriminatorEventHub
	return json.Marshal(objectMap)
}
...
func (e *EventHubEndpoint) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "fullyQualifiedNamespace":
			err = unpopulate(val, "FullyQualifiedNamespace", &e.FullyQualifiedNamespace)
			delete(rawMsg, key)
		case "type":
			err = unpopulate(val, "Type", &e.Type)
			delete(rawMsg, key)
...
func (e *EventListener) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "endpoint":
			e.Endpoint, err = unmarshalEventListenerEndpointClassification(val)
			delete(rawMsg, key)
		case "filter":
			e.Filter, err = unmarshalEventListenerFilterClassification(val)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", e, err)
...
func (e EventNameFilter) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "systemEvents", e.SystemEvents)
	objectMap["type"] = EventListenerFilterDiscriminatorEventName
	populate(objectMap, "userEventPattern", e.UserEventPattern)
	return json.Marshal(objectMap)
}
...
func (h *HubProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		var err error
		switch key {
		case "anonymousConnectPolicy":
			err = unpopulate(val, "AnonymousConnectPolicy", &h.AnonymousConnectPolicy)
			delete(rawMsg, key)
		case "eventHandlers":
			err = unpopulate(val, "EventHandlers", &h.EventHandlers)
			delete(rawMsg, key)
		case "eventListeners":
