...
func (s SavingsPlanModelProperties) MarshalJSON() ([]byte, error) {
	...
	populateTimeRFC3339(objectMap, "benefitStartTime", s.BenefitStartTime)
	...
	populateTimeRFC3339(objectMap, "effectiveDateTime", s.EffectiveDateTime)
	populateTimeRFC3339(objectMap, "expiryDateTime", s.ExpiryDateTime)
...
func (s *SavingsPlanModelProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "benefitStartTime":
			err = unpopulateTimeRFC3339(val, "BenefitStartTime", &s.BenefitStartTime)
			delete(rawMsg, key)
		...
		case "displayProvisioningState":
			...
			delete(rawMsg, key)
		case "effectiveDateTime":
			err = unpopulateTimeRFC3339(val, "EffectiveDateTime", &s.EffectiveDateTime)
			delete(rawMsg, key)
		case "expiryDateTime":
			err = unpopulateTimeRFC3339(val, "ExpiryDateTime", &s.ExpiryDateTime)
			delete(rawMsg, key)
		case "extendedStatusInfo":
		...
		case "purchaseDateTime":
			err = unpopulateTimeRFC3339(val, "PurchaseDateTime", &s.PurchaseDateTime)
			delete(rawMsg, key)
		case "renew":
