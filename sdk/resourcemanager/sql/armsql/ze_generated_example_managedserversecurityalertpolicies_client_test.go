...
func ExampleManagedServerSecurityAlertPoliciesClient_Get() {
	...
	client, err := armsql.NewManagedServerSecurityAlertPoliciesClient("00000000-1111-2222-3333-444444444444", cred, nil)
	if err != nil {
...
func ExampleManagedServerSecurityAlertPoliciesClient_NewListByInstancePager() {
	...
	pager := client.NewListByInstancePager("securityalert-4799",
		"securityalert-6440",
		nil)
	for pager.More() {
