...
func ExampleManagedRestorableDroppedDatabaseBackupShortTermRetentionPoliciesClient_Get() {
	...
	client, err := armsql.NewManagedRestorableDroppedDatabaseBackupShortTermRetentionPoliciesClient("00000000-1111-2222-3333-444444444444", cred, nil)
	if err != nil {
...
func ExampleManagedRestorableDroppedDatabaseBackupShortTermRetentionPoliciesClient_NewListByRestorableDroppedDatabasePager() {
	...
	pager := client.NewListByRestorableDroppedDatabasePager("Default-SQL-SouthEastAsia",
		"testsvr",
		"testdb,131403269876900000",
		nil)
	for pager.More() {
