...
import (
	...
	"github.com/c-brooks/azure-sdk-for-go/sdk/resourcemanager/securitydevops/armsecuritydevops"
)
...
func ExampleAzureDevOpsConnectorClient_NewListByResourceGroupPager() {
	...
	client, err := armsecuritydevops.NewAzureDevOpsConnectorClient("00000000-0000-0000-0000-000000000000", cred, nil)
	if err != nil {
...
func ExampleAzureDevOpsConnectorClient_BeginCreateOrUpdate() {
	...
	poller, err := client.BeginCreateOrUpdate(ctx, "westusrg", "testconnector", armsecuritydevops.AzureDevOpsConnector{
...
func ExampleAzureDevOpsConnectorClient_BeginUpdate() {
	...
	poller, err := client.BeginUpdate(ctx, "westusrg", "testconnector", armsecuritydevops.AzureDevOpsConnector{
		Location: to.Ptr("West US"),
