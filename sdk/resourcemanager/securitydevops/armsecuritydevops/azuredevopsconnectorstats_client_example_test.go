...
func ExampleAzureDevOpsConnectorStatsClient_Get() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	ctx := context.Background()
	client, err := armsecuritydevops.NewAzureDevOpsConnectorStatsClient("00000000-0000-0000-0000-000000000000", cred, nil)
	if err != nil {
