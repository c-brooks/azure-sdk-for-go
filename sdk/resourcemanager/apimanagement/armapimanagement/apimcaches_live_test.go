...
func (testsuite *ApimcachesTestSuite) SetupSuite() {
	...
	testsuite.cacheId = testutil.GenerateAlphaNumericID(testsuite.T(), "cacheid", 6)
	testsuite.serviceName = testutil.GenerateAlphaNumericID(testsuite.T(), "servicecache", 6)
