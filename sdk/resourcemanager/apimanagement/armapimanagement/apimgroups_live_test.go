...
func (testsuite *ApimgroupsTestSuite) SetupSuite() {
	...
	testsuite.groupId = testutil.GenerateAlphaNumericID(testsuite.T(), "groupid", 6)
	testsuite.serviceName = testutil.GenerateAlphaNumericID(testsuite.T(), "servicegroup", 6)
