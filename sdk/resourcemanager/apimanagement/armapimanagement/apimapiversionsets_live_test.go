...
func (testsuite *ApimapiversionsetsTestSuite) SetupSuite() {
	...
	testsuite.serviceName = testutil.GenerateAlphaNumericID(testsuite.T(), "serviceapiversionsets", 6)
	testsuite.versionSetId = testutil.GenerateAlphaNumericID(testsuite.T(), "versionset", 6)
