...
func (testsuite *ContainerregistryTestSuite) TestExportpipelines() {
	...
	testsuite.Require().NoError(err)
	_, err = testutil.PollForTest(testsuite.ctx, exportPipelinesClientCreateResponsePoller)
	testsuite.Require().NoError(err)
...
func (testsuite *ContainerregistryTestSuite) TestImportpipelines() {
	...
	testsuite.Require().NoError(err)
	_, err = testutil.PollForTest(testsuite.ctx, importPipelinesClientCreateResponsePoller)
	testsuite.Require().NoError(err)
