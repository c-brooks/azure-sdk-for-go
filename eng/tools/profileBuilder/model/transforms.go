		...
		go func(pd string) {
			filepath.Walk(pd, func(path string, info os.FileInfo, err error) error {
				...
				for pn := range packages {
					...
					// becomes github.com/c-brooks/azure-sdk-for-go/profiles/2017-03-09/compute/mgmt/compute
...
// Licensed under the MIT License. See License.txt in the project root for license information.`)
	...
	fmt.Fprintln(generatorStampBuilder, "// github.com/c-brooks/azure-sdk-for-go/eng/tools/profileBuilder")
